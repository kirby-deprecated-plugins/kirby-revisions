...
<table class="structure-table revisions">
	<tbody>
		<?php foreach( $revisions as $revision) : ?>
			...
			<tr>
				<td>
					<a href="<?php echo RevisionContent::url( $page, $filename ); ?>" target="_blank">
						<span class="revision-date">
							<i class="fa fa-calendar"></i>
							<?php echo RevisionContent::date( $filename ); ?> 
						</span>
					
						<span class="revision-time">
							<i class="fa fa-clock-o"></i>
							<?php echo RevisionContent::time( $filename ); ?>
						</span>

						<span class="revision-template">
							<i class="fa fa-file-code-o"></i>
							<?php echo RevisionContent::template( $filename ); ?>
						</span>
					</a>
				</td>
			</tr>
